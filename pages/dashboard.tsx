...
export default function DashboardPage() {
  ...
  const healKami = useCallback(async (index) => {
    ...
    const transactionRequest = {
      from: operator,
      to: '0xD5a464b87A80C141df5abF1f741991CD9E651187',
      ...
      <div className="sticky top-0 left-0 right-0 bg-yellow-100 border-b-2 border-yellow-300 p-4 text-center z-50">
        <div className="flex items-center justify-center">
          ...
          <span className="text-yellow-800 font-semibold">
            Warning: This site only works while this tab is active and visible. Keep your pc awake and this tab open and visible to ensure your Kamis are cared for! Check the FAQ for details.
          </span>
        </div>
      </div>
